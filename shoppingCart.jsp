...
String email1="freddy@gmail.com";
...
int userId = userDao.getUserIdByEmail(email1);
// out.print(userId);
if (userId == 0) {
...
<%
    // Fetch user ID from session or any other source
  //  int userId = 17;  // Example user ID, replace this with session or actual user ID
...
if (userId == 0) {
    ...
    // Initialize CartDao and fetch the cart items for the user
    CartDao cartDao = new CartDao();
        ...
        %>
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><%= item.getTitle() %></td>
                        <td><%= item.getArtistName() %></td>
                        <td><%= item.getCategory() %></td>
                        <td>&#8377; <%= item.getPrice() %></td>
                        <td><a href="removeFromCart.jsp?cartId=<%= item.getCartId() %>" class="btn btn-danger btn-sm">Remove</a></td>
                    </tr>
                    <%
                        }
                    %>
